...
import Level.BattleLevels.BattleLevel_07;
import Level.BattleLevels.BattleLevel_08;
import Level.BattleLevels.BattleLevel_09;
...
public class StoryLevel_06 extends StoryLevelBase
{
    private DialogueButton testButton2;
    private DialogueButton testButton3;
    private int levelChoose = 0;
    @Override
    protected void initDialogue()
    {
        textPath = "assets/Text/06.txt";
...
//        testButton3.setPosition(stage.getWidth() / 2 - testButton2.getButton().getWidth() / 2, 100);
    ...
    protected LevelBase loadNextLevel()
    {
        if(levelChoose == 0)
        {
            return new BattleLevel_07();
        }
        else if(levelChoose == 1)
        {
            return new BattleLevel_08();
        }
        else
        {
            return new BattleLevel_09();
        }
    }
}
