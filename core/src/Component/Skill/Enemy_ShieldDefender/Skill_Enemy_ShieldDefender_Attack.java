package Component.Skill.Enemy_ShieldDefender;
...
public class Skill_Enemy_ShieldDefender_Attack extends Skill_Attack
{

    public Skill_Enemy_ShieldDefender_Attack(CharacterBase character)
    {
        super(character);
    }
