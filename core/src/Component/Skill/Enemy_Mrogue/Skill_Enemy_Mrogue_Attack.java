package Component.Skill.Enemy_Mrogue;
...
public class Skill_Enemy_Mrogue_Attack extends Skill_Attack
{

    public Skill_Enemy_Mrogue_Attack(CharacterBase character)
    {
        super(character);
    }
